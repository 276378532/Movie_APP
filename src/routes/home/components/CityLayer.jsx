            ...
            <div className="cityLayer">
                ...
                <div className="cityLayer__content">
                    ...
                    <div className="cityBlock" id="热门">
                        ...
                        <div className="cityBlock__wrap">
                            {hot.map(city => <div key={city.citiCode} className="cityBlock__item" onClick={()=>onSelect(city.regionName)}>{city.regionName}</div>)}
                        </div>
                    </div>
                        ...
                        return (
                            <div className="cityList" id={alphabet} key={alphabet}>
                                ...
                                <ul className="cityList__wrap">
                                    {citys.map(city=><li  kty={city.citiCode} className="cityList__item" onClick={()=>onSelect(city.regionName)}>{city.regionName}</li>)}
                                </ul>
                            </div>
                        )
                    })}
